...
import { proxyRequest, handleOptions } from './src/lib/proxy';
...
console.log(`Premium tier limit: ${config.PREMIUM_TIER_LIMIT.toLocaleString()} tokens/day`);
console.log(`Mini tier limit: ${config.MINI_TIER_LIMIT.toLocaleString()} tokens/day`);
